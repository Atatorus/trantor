...
/**
 * A test case is a base part of a test. Typically, a test case represents a method in unit tests.
 *
 * @param description a simple explanation of the test case. By example `User creation nominal case`,
 * `User creation without email test`.
 * @param expected The expected response.
 * @Param order used to sort test case in report.
 *
 */
