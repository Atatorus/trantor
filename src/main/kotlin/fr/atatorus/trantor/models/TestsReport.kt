...
/**
 * The report for several tests. In unit testing, it is equivalent to a test class.
 *
 ...
 *
 */
class TestsReport(override val title: String, descriptions: List<String>): ITestsReport {

    override val descriptions: MutableList<String> = arrayListOf()
    override val tests: MutableMap<String, Test> = hashMapOf()
    ...
    override fun currentTest(testName: String, testOrder: Int, vararg testDescriptions: String) {
        val test = test(testName).also {
            it.order = testOrder
    ...
    private fun test(testName: String): Test {
    ...
    override fun testFailure(message: String) {
        currentCase?.failure(message)
    }

    override fun newTestCase(caseDescription: String, expected: String, caseOrder: Int) {
        val testCase = TestCase(caseDescription, expected, caseOrder)
        currentTest?.addTestCase(testCase)
